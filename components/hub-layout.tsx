...
export function HubLayout({
    ...
    return (
        <>
            ...
            <div className="bg-background/50 sticky top-0 z-50 mb-4 flex items-center justify-between gap-4 border-b border-muted-foreground/20 px-4 py-3 backdrop-blur-xs shadow-sm transition-all">
                <div className="flex items-center gap-4 overflow-hidden">
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <SidebarTrigger className="flex-shrink-0 size-6" />
                        </TooltipTrigger>
